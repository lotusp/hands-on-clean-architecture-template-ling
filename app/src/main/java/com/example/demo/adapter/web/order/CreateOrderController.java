 ...
 * Requirements: 1.1.4, 1.1.7, 1.1.8, 1.1.9, 1.1.10, 1.3.6
 */
@RestController
...
public class CreateOrderController {
    ...
    public record CreateOrderRequest(
        ...
        /**
         * Request for an order item.
         */
        public record OrderItemRequest(
            @NotNull(message = "餐品ID不能为空") 
            String dishId,
            
            @NotNull(message = "餐品名称不能为空") 
            String dishName,
        ...
        /**
         * Request for delivery information.
         */
